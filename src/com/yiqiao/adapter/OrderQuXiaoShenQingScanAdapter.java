...
import com.yiqiao.adapter.OrderWeiFaHuoScanAdapter.ViewHolder;
...
public class OrderQuXiaoShenQingScanAdapter extends BaseAdapter{
	...
	public OrderQuXiaoShenQingScanAdapter(Context context, List<OrderTotalInfo> orderTotalInfos) {
		super();
...
//				MyToast.toast(mContext, "agree:"+ps, 0);
				...
				((OrderQuXiaoShengQingScanActivity)mContext).startActivityForResult(intent2, 1);//同意取消
				break;
...
//				MyToast.toast(mContext, "not agree"+ps, 0);
				...
				((OrderQuXiaoShengQingScanActivity)mContext).startActivityForResult(intent3, 2);//不同意取消
				break;
