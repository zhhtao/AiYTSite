...
public class OrderTuiHuoZhongScanAdapter extends BaseAdapter{
	...
	public OrderTuiHuoZhongScanAdapter(Context context, List<OrderTotalInfo> orderTotalInfos) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.order_tui_huo_zhong_scan_list_item, null);
			viewHolder.orderSeq = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_seq);
			viewHolder.goodsName = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_goods_name);
			viewHolder.goodsAttri = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_goods_attri);
			viewHolder.priceValue = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_price_value);
			viewHolder.goodsAmount = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_amount);
			viewHolder.creatTime = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_create_time);
			viewHolder.totalMoney = (TextView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_total_money);
			
			viewHolder.queryLogicsticsButton = (Button) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_qurey_logicstics_btn);
			viewHolder.goodsImageView = (ImageView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_goods_image);
			viewHolder.toDetailImage = (ImageView) convertView.findViewById(R.id.order_tui_huo_zhong_list_item_arrow_detail);
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
			case R.id.order_tui_huo_zhong_list_item_qurey_logicstics_btn:
//				MyToast.toast(mContext, "cancle:"+ps, 0);
//				Toast  toast  = Toast.makeText(mContext, "该功能尚未开通！", Toast.LENGTH_SHORT);
//				toast.setGravity(Gravity.CENTER, 0, 0);
//				toast.show();
				Toast.makeText(mContext, "该功能尚未开通！", Toast.LENGTH_SHORT).show();
				break;
				

				
			case R.id.order_tui_huo_zhong_list_item_arrow_detail:
