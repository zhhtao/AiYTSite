...
public class OrderYiWanChengScanActivity extends FinalActivity {
	@ViewInject(id=R.id.order_yi_wan_cheng_scan_progress_bar_layout)private RelativeLayout progressBarLayout;
	@ViewInject(id=R.id.order_yi_wan_cheng_scan_show_info_layout)private LinearLayout showInfoLayout;
	@ViewInject(id=R.id.order_yi_wan_cheng_scan_title_back)private ImageView backImageView; 
	@ViewInject(id=R.id.order_yi_wan_cheng_scan_listview)private ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.order_yi_wan_cheng_scan_layout);
		mContext = this;
	...
	private void qureyDataFromServer() {
		...
		for (int i=0; i<10; i++) {
			...
			orderTotalInfo.setOrderState(MyConstants.ORDER_STATE_WANCHENG);
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			switch (v.getId()) {
			case R.id.order_yi_wan_cheng_scan_title_back:
				back();
				break;
