...
public class OrderYiFaHuoScanActivity extends FinalActivity{
	...
	private OrderYiFaHuoScanAdapter adapter;//数据填充适配器
	...
	private void initView() {
		...
		adapter = new OrderYiFaHuoScanAdapter(mContext, orderTotalInfosList);
	...
	private void qureyDataFromServer() {
		...
		for (int i=0; i<10; i++) {
			...
			orderTotalInfo.setOrderState(MyConstants.ORDER_STATE_YIFAHUO);
