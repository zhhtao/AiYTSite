...
import com.yiqiao.stockpile.StockControlActivity.MyClassifyListener;
import com.yiqiao.ui.CustomProgress;
import com.yiqiao.util.MyConstants;
public class StockUploadActivity extends Activity{
...
//				MyToast.toast(mContext, "rou", 1);
				...
				Intent intentRou = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "qin", 1);
				Intent intentQin = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "dan", 1);
				Intent intentDan = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "shucai", 1);
				Intent intent4 = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "shuiguo", 1);
				Intent intent5 = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "liangyou", 1);
				Intent intent6 = new Intent(mContext, StockClassifyLevel1.class);
...
//				MyToast.toast(mContext, "jiucha", 1);
				Intent intent7 = new Intent(mContext, StockClassifyLevel1.class);
...
//		
//		Button button = (Button) findViewById(R.id.btn_b_one);
//        button.setOnClickListener(new OnClickListener() {
//			
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
////				Toast.makeText(StockUploadActivity.this, "b button", Toast.LENGTH_SHORT).show();
////				CustomProgress.show(StockUploadActivity.this, "load", true, null);
//				new ProgressDialog(StockUploadActivity.this).show();
//				
//			}
//		});
//	}
